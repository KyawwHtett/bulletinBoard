									...
									<p class="card-text text-justify text-muted">
										...
										<c:if
											...
											<a href="#" data-bs-toggle="modal"
												data-modal-id="n-${post.post_id }"
												data-bs-target="#postModal"
												class="badge badge-danger text-white delete-btn">Delete</a>
										</c:if>
									</p>
								</div>
							</div>
	...
	<div class="modal fade" id="postModal" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">Are you sure want to delete this post?</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary"
						data-bs-dismiss="modal">Close</button>
					<a class="btn btn-danger btn-ok"
						href="<c:url value="/post/delete/id" />" id="modal-delete-btn">OK</a>
				</div>
			</div>
		</div>
	</div>
